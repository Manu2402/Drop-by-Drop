...
TSharedPtr<FSlateStyleSet> FErosionScapeStyle::StyleInstance = nullptr;

void FErosionScapeStyle::Initialize()
{
...
void FErosionScapeStyle::Shutdown()
{
...
FName FErosionScapeStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("ErosionScapeStyle"));
	return StyleSetName;
}
...
void FErosionScapeStyle::ReloadTextures()
{
...
const ISlateStyle& FErosionScapeStyle::Get()
{
